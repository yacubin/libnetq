...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(LibNetQ REQUIRED_VARS LibNetQ_LIBRARY LibNetQ_INCLUDE_DIR)
if (LIBNETQ_FOUND)
  set(LibNetQ_FOUND TRUE)
endif ()

if (LibNetQ_FOUND)
  set(LibNetQ_DEPENDENCIES "")
  get_filename_component(LibNetQ_LIBRARY_EXTNAME "${LibNetQ_LIBRARY}" LAST_EXT)
  if (CMAKE_SYSTEM_NAME STREQUAL "Windows" AND "${LibNetQ_LIBRARY_EXTNAME}" MATCHES "(.a|.lib)$")
    list(APPEND LibNetQ_DEPENDENCIES ws2_32 wsock32)
  endif ()
  set(LibNetQ_INCLUDE_DIRS "${LibNetQ_INCLUDE_DIR}")
  set(LibNetQ_LIBRARIES "${LibNetQ_LIBRARY}" ${LibNetQ_DEPENDENCIES})
endif()
...
if (LibNetQ_FOUND AND NOT TARGET LibNetQ::LibNetQ)
  ...
  set_target_properties(LibNetQ::LibNetQ PROPERTIES INTERFACE_LINK_LIBRARIES "${LibNetQ_DEPENDENCIES}")
