...
if (MHD_FOUND)
  set(MHD_DEPENDENCIES "")
  get_filename_component(MHD_LIBRARY_EXTNAME "${MHD_LIBRARY}" LAST_EXT)
  if (CMAKE_SYSTEM_NAME STREQUAL "Windows" AND "${MHD_LIBRARY_EXTNAME}" MATCHES "(.a|.lib)$")
    list(APPEND MHD_DEPENDENCIES ws2_32 wsock32)
  endif ()
...
if (MHD_FOUND AND NOT TARGET MHD::MHD)
  ...
  set_target_properties(MHD::MHD PROPERTIES INTERFACE_LINK_LIBRARIES "${MHD_DEPENDENCIES}")
