...
if (PCRE2_FOUND AND NOT TARGET PCRE2::PCRE2)
  ...
  set_property(TARGET PCRE2::PCRE2 PROPERTY INTERFACE_LINK_LIBRARIES ${PCRE2_LIBRARIES})
  set_property(TARGET PCRE2::PCRE2 PROPERTY INTERFACE_COMPILE_DEFINITIONS ${PCRE2_DEFINITIONS})
endif ()
