...
#ifndef _LIBNETQ_STRING_CSTRBASE_H
#define _LIBNETQ_STRING_CSTRBASE_H
...
static inline bool NQIsCStrEmpty(const char* str)
{
  return *str == NQ_NIL;
}

static inline bool NQIsCStrNullOrEmpty(const char* str)
{
...
#endif /* _LIBNETQ_STRING_CSTRBASE_H */
