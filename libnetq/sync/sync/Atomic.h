...
#ifndef _LIBNETQ_SYNC_SYNC_ATOMIC_H
#define _LIBNETQ_SYNC_SYNC_ATOMIC_H
...
{
  return return __sync_add_and_fetch(&thiz->counter, i);
}
...
{
  return __sync_val_compare_and_swap(&thiz->counter, oldVal, newVal);
}
...
#endif /* _LIBNETQ_SYNC_SYNC_ATOMIC_H */
